...
substitution - is consistent with, and partially extends, Dayan et al. 2010's own
...
**Evidence framing, precisely stated:** AF273767 is *Zea mays* (confirmed via NCBI
esummary), which is already one of the 10 species in our conservation panel and
does show Ala at the equivalent alignment column - the same data point Dayan cited,
not an independent confirmation of it. What our panel adds beyond Dayan's own text:
three *other* species he didn't specifically name also carry Ala at this position -
Arabidopsis (KAL9810292.1), soybean (KAH1193770.1), and poplar (XP_002298607.3) -
plus tomato (NP_001335308.1). So this is **consistent with, and partially extending,
Dayan et al. 2010's cross-species survey** - not two independent lines of evidence,
since one of our ten data points is the exact species he already reported.
